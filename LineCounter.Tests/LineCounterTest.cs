...
namespace LineCounter.Tests
{
    ...
    public class LineCounterTest
    {
        ...
        {
            [TestFixture]
            public class GivenFileIsInvalid
            {
                [TestCase("")]
                [TestCase(null)]
            ...
            [TestFixture]
            public class GivenFileIsValid
            {
                [Test]
                public void AndHasNoBlankLines_ShouldReturnLineCount()
                {
                    //Arrange
                    var filePath = "test";
                ...
                {
                    [Test]
                    public void ShouldExcludeLinesWithinBlockComment()
                    {
                        //Arrange
                        var filePath = "test";
                        const int expected = 5;
                ...
                public class SingleLineComments
                {
                    ...
                    public void ShouldExcludeLinesThatStartWithSingleLineComment(string singleLineComment)
                    {
                        //Arrange
                        var filePath = "test";
                        const int expected = 6;
